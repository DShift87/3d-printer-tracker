...
export function PartsIcon({ className = "", active = false }: PartsIconProps) {
  if (active) {
    return (
      <svg
        ...
        className={className}
      >
        <g clipPath="url(#clip0-parts-active)">
          <mask id="mask0-parts-active" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-1" y="0" width="25" height="24">
            <path d="M23.999 0H-0.000976562V24H23.999V0Z" fill="white" />
          </mask>
          <g mask="url(#mask0-parts-active)">
        ...
        <defs>
          <clipPath id="clip0-parts-active">
  ...
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0-parts-inactive)">
        <mask id="mask0-parts-inactive" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
          <path d="M24 0H0V24H24V0Z" fill="white" />
        </mask>
        <g mask="url(#mask0-parts-inactive)">
      ...
      <defs>
        <clipPath id="clip0-parts-inactive">
          <rect width="24" height="24" fill="white" />
        </clipPath>
      </defs>
    </svg>
