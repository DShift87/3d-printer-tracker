...
export function DashboardIcon({ className = "" }: DashboardIconProps) {
  return (
    <svg 
      ...
      className={className}
    >
      <g clipPath="url(#clip0_706_354)">
        <mask id="mask0_706_354" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
          <path d="M24 0H0V24H24V0Z" fill="white"/>
        </mask>
        <g mask="url(#mask0_706_354)">
          <path 
